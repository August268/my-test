...
def chunk_markdown(markdown: str, *, article_id: int, slug: str, title: str, source_url: str, updated_at: str) -> List[Chunk]:
    ...
    for section in sections:
        ...
        for text in sub_chunks:
            ...
            chunks.append(
                Chunk(chunk_name, text, metadata)
            )
